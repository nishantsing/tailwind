...
const Notification = () => {
  return (
    <div className="flex max-w-sm items-center gap-x-4 rounded-xl bg-white p-6 shadow-lg outline outline-black/5 dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
      <img className="size-12 shrink-0 bg-white" src={chatIcon} alt="ChitChat Logo" />
      <img className="size-12 shrink-0 bg-white" src="/img/vite.svg" alt="ChitChat Logo" />
      <div>
...
/* 
To Ways to show image
1. public path can be directly added on to src
2. anyother path needs to be imported and used.

mx-auto to center it horizontally
*/
